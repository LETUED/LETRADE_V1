...
from src.common.db_config import DatabaseInitializer, DatabaseHealthChecker
...
class TestDatabaseManager:
    ...
    def test_database_url_defaults(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            manager = DatabaseManager()
            expected_url = "postgresql://letrade_user:letrade_password@localhost:5432/letrade_db"
            assert manager._get_database_url() == expected_url
