...
class MessageBus:
    ...
    async def disconnect(self) -> bool:
        ...
        """
        try:
            logger.info("Disconnecting from RabbitMQ", extra={"component": "message_bus"})
    ...
    async def _setup_infrastructure(self):
        ...
        await self._declare_exchange("letrade.dlx", "topic", durable=True)  # Dead letter exchange
