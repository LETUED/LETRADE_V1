...
class ComponentStatusResponse(BaseModel):
    ...
    last_heartbeat: Optional[str] = Field(default=None, description="Last heartbeat timestamp")
...
class SystemStatusResponse(BaseModel):
    ...
    # Market data
    market_data_lag: Optional[int] = Field(default=None, description="Market data lag in milliseconds")
    last_price_update: Optional[str] = Field(default=None, description="Last price update timestamp")
    
    # Timestamps
    timestamp: str = Field(description="Status timestamp")
    last_restart: Optional[str] = Field(default=None, description="Last system restart timestamp")
...
class MetricsResponse(BaseModel):
    ...
    avg_trade_execution_time: float = Field(description="Average trade execution time in milliseconds")
...
class PerformanceResponse(BaseModel):
    ...
    current_drawdown: Optional[float] = Field(default=None, description="Current drawdown")
...
class AlertResponse(BaseModel):
    ...
    component: Optional[str] = Field(default=None, description="Component that triggered the alert")
    strategy_id: Optional[int] = Field(default=None, description="Strategy ID if related")
    portfolio_id: Optional[int] = Field(default=None, description="Portfolio ID if related")
...
class SystemConfigResponse(BaseModel):
    ...
    exchange_config: Dict[str, Any] = Field(description="Exchange connector configuration")
