...
class APIService:
    ...
    async def send_request(self, routing_key: str, request_data: Dict[str, Any], timeout: int = None) -> Dict[str, Any]:
    ...
    async def list_strategies(self, user_id: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """List all strategies.
    ...
    async def create_strategy(self, user_id: str, strategy_data: Dict[str, Any]) -> Dict[str, Any]:
        """Create new strategy.
    ...
    async def update_strategy(self, user_id: str, strategy_id: int, update_data: Dict[str, Any]) -> Dict[str, Any]:
        """Update strategy.
    ...
    async def control_strategy(self, user_id: str, strategy_id: int, action: str, parameters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def list_portfolios(self, user_id: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """List all portfolios.
    ...
    async def update_portfolio(self, user_id: str, portfolio_id: int, update_data: Dict[str, Any]) -> Dict[str, Any]:
        """Update portfolio.
    ...
    async def get_system_metrics(self, user_id: str, period: str = 'hour') -> Dict[str, Any]:
        """Get system metrics.
