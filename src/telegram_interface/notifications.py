...
class NotificationManager:
    ...
    def __init__(self):
        ...
        # Rate limiting
        self.notification_counts: Dict[int, Dict[str, int]] = (
            {}
        )  # Per-user, per-category counts
    ...
    def add_subscriber(
        self, chat_id: int, filters: Optional[Dict[str, Any]] = None
    ) -> None:
...
포트폴리오에 상당한 변동이 있었습니다.
    ...
    def _update_rate_limit_count(
        self, chat_id: int, category: NotificationCategory
    ) -> None:
    ...
    def _should_send_notification(
        self, chat_id: int, category: NotificationCategory, level: NotificationLevel
    ) -> bool:
